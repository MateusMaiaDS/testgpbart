...
RcppExport SEXP _testgpbart_symm_distance_matrix(SEXP m1SEXP, SEXP phi_vectorSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _testgpbart_distance_matrix(SEXP m1SEXP, SEXP m2SEXP, SEXP phi_vectorSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type m1(m1SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_testgpbart_symm_distance_matrix", (DL_FUNC) &_testgpbart_symm_distance_matrix, 2},
    {"_testgpbart_distance_matrix", (DL_FUNC) &_testgpbart_distance_matrix, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_testgpbart(DllInfo *dll) {
