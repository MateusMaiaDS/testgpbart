---
title: "Testing GPBART"
author: "Mateus Maia 20250756"
date: "2022-11-16"
output: pdf_document
---
### Setting a example
...
The list above would refer to a prior given by $$ 0.5 \times G(\alpha = 1, \beta = 1)+0.5 \times \left(\alpha = 1000, \beta = 10 \right)$$
...
To get the posterior distribution for $\phi_{tp}$ we gonna need to select which tree $t$ and which $p$ we are selecting.
